...
<div class="bg-image" style="background-image: url('assets/img/photos/photo21@2x.jpg');">
    <div class="bg-primary-dark-op">
        <div class="content content-full content-top">
            <h1 class="py-50 text-white text-center">Edit Pengadaan Bahan Baku</h1>
        </div>
    </div>
</div>
<div class="content">
        ...
        <div class="col-lg-12">
            ...
            <div class="block block-rounded">
                <div class="block-content">
                    ...
                    <form action="{{route('pengadaan.update',$d->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group row {{ $errors->has('nama') ? ' is-invalid' : '' }}">
                                ...
                                <div class="form-group row {{ $errors->has('bahan') ? ' is-invalid' : '' }}">
                                    <div class="col-md-12">
                                            ...
                                            <select class="form-control" name="baku" id="baku" value="" disabled>
