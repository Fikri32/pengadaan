...
<div class="bg-image" style="background-image: url('assets/img/photos/photo21@2x.jpg');">
    <div class="bg-primary-dark-op">
        <div class="content content-full content-top">
            <h1 class="py-50 text-white text-center">Kelola Stok Bahan Baku Keluar</h1>
        </div>
    </div>
</div>
<div class="content">
        ...
        <div class="col-lg-12">
            <div class="block block-rounded">
                <div class="block-content bg-body-light">
                    <!-- Search -->
                    <form action="{{route('keluar.cari')}}" method="get">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">List Stok Bahan Baku Keluar</h3>
                    ...
                    <table class="js-table-checkable table table-hover js-table-checkable-enabled">
                        ...
                        <?php $no++ ;?>
                            ...
                            <td>{{$no}}</td>
                                ...
                                <a class="btn btn-rounded btn-alt-danger mr-10 Hapus" href="{{ url('bahankeluar/delete/'.$d->id) }}">
...
<script type="text/javascript">
    ...
    swal({
        ...
        text: "Data Bahan Baku Keluar Tidak Akan Bisa Di Kembalikan Jika Di Hapus",
        icon: "warning",
        buttons: true,
        dangerMode: true,
        })
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    type: "DELETE",
                    url:  '/bahankeluar/delete/'+delete_id,
                    data : data,
