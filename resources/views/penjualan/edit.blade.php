                            ...
                            <div class="form-group row {{ $errors->has('produk') ? ' is-invalid' : '' }}">
                                ...
                                <div class="form-group row {{ $errors->has('bulan') ? ' is-invalid' : '' }}">
                                    <div class="col-md-12">
                                            ...
                                            <input type="month" class="form-control" id="tanggal" name="tanggal" value="{{$d->tanggal}}" data-date-format="dd-mm-yyyy" data-language="id" placeholder="Masukan Penjualan Perbulan">
                                        @if ($errors->has('bulan'))
                                            <div class="invalid-feedback">
