                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        ...
                                        @foreach($komposisi as $k)
                                            <form action="{{route('komposisi.update',$k->id)}}" method="post" class="form-horizontal">
                                            @csrf
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <a href="dataproduk_produksi.php" title="" class="btn btn-sm btn-secondary">
                        ...
                        <?php $no = 0;?>
                          ...
                          <?php $no++ ;?>
                            ...
                            <input type="hidden" class = "hapus_data" value = "{{$d->id}}">
                                ...
                                <td>{{$d->jumlah}}</td>
                                <td>
                                <a class="btn btn-rounded btn-alt-secondary mr-10 p" href="">
