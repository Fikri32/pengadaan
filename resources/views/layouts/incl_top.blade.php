...
<title>Sistem Informasi Manajemen Pengadaan &amp;</title>
...
<link rel="stylesheet" id="css-main" href="{{ asset('assets/css/input_file.css') }}">
...
<!-- Signature Pad -->
<link rel="stylesheet" href="{{ asset('assets/signature/jquery.signaturepad.css') }}">
